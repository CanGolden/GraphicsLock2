...
public class ThreadPoolManager {
	...
	private List<ITask> taskQueue = Collections
			.synchronizedList(new LinkedList<ITask>());// The task queue
	private WorkThread[] workQueue; // The worker thread (the real task
									// execution thread)
	private static int worker_num = 5; // The number of worker threads (5 is the
